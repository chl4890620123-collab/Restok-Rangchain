...
TEXT_SUFFIXES = {".css", ".env", ".example", ".gradle", ".html", ".java", ".js", ".json", ".md", ".properties", ".py", ".sh", ".txt", ".xml", ".yaml", ".yml"}
TEXT_NAMES = {"Dockerfile", ".dockerignore", ".editorconfig", ".gitattributes", ".gitignore", "requirements.txt", "gradlew"}
